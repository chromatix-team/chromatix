...
coefficients_truth = jnp.array([2.,5.,3.,0,1,0,1,0,1,0])
...
class ZernikePSF(nn.Module):
    ...
    def __call__(self, z):
        ...
        field = ZernikeAberrations(n, f, NA, ansi_indices, trainable(jnp.array([0.] * len(ansi_indices))))(field)
...
params_truth = {'params':{'ZernikeAberrations_0': {'zernike_coefficients': coefficients_truth}}}
...
coefficients_estimated = jnp.abs(params['params']['ZernikeAberrations_0']['zernike_coefficients'])
...
mean_coefficients_error = jnp.mean(jnp.square(coefficients_estimated - coefficients_truth))
