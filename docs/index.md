...
!!! info
    Check out an overview of Chromatix in [Chromatix 101](101.ipynb) and the updated examples. You may also want to take a look at the [updated guide on optimization](training.ipynb) if you were ever using Chromatix elements/Flax modules previously.
