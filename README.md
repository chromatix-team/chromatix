...
## Notice ℹ️
Check out an overview of Chromatix in [Chromatix 101](https://chromatix.readthedocs.io/en/latest/101/) and the updated examples. You may also want to take a look at the [updated guide on optimization](https://chromatix.readthedocs.io/en/latest/training/) if you were ever using Chromatix elements/Flax modules previously.
